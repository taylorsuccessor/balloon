  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-newsletteraffiliate_total ">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($newsletter['newsletter_id'], $selected)) { ?>
                  ...
                  <td class="text-left"><?php echo $newsletter['status']; ?></td>

...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
		...
		$data['payment_address_1']=array_key_exists('payment_address_1',$data)? $data['payment_address_1']:'';
		$data['payment_address_2']=array_key_exists('payment_address_2',$data)? $data['payment_address_2']:'';
		$data['payment_postcode']=array_key_exists('payment_postcode',$data)? $data['payment_postcode']:'';
		$data['shipping_address_1']=array_key_exists('shipping_address_1',$data)? $data['shipping_address_1']:'';
		$data['shipping_address_2']=array_key_exists('shipping_address_2',$data)? $data['shipping_address_2']:'';
		$data['shipping_postcode']=array_key_exists('shipping_postcode',$data)? $data['shipping_postcode']:'';
